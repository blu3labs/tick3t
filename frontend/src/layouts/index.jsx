...
export default function MainLayout() {
  ...
  useEffect(() => {
    ;(async () => {
      const options = {
        clientId: 'BPuRRfHaSiEY7lO6bxcDaBkNM12nfcedhdB6w3QPuLOPsu-MqR0Zbq918xazA76nBM586rsFsVbZ3sTNnfGFnis',
  ...
  return (
    <AppWrapper>
      <Toaster />
      <Header login={login} authData={safeAuthSignInResponse} logout={logout}  modalProvider={web3AuthModalPack} setSafeAuthSignInResponse={setSafeAuthSignInResponse} />
      <Outlet />
    </AppWrapper>
  );
}
